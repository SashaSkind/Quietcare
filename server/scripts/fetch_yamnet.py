...
def main() -> int:
    ...
    print()
    print("Files are in server/models/, which the app auto-resolves on any")
    print("machine. You do NOT need to set YAMNET_MODEL_PATH / YAMNET_LABELS_PATH")
    print("(leave them blank). Just set in server/.env:")
    print("  AUDIO_SCENE_BACKEND=yamnet   # or leave 'auto'; 'both' ensembles PANNs")
    print()
